(ns marketentry.phase
  "Phase 0->3 staged rollout for the Republic of Cuba (CUB) market-entry
  compliance actor.
  ...
  real MINCEX filing package and submitting a real filing / Registro
  Mercantil inscription request are the two real-world acts this actor
